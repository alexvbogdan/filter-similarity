...
class InceptionA(nn.Module):
    def __init__(self, input_channels, pool_features):
        ...
        self.branch5x5 = nn.Sequential(
            BasicConv2d(input_channels, 48, kernel_size=1), BasicConv2d(48, 64, kernel_size=5, padding=2)
        )
...
class InceptionD(nn.Module):
    def __init__(self, input_channels):
        ...
        self.branch3x3 = nn.Sequential(
            BasicConv2d(input_channels, 192, kernel_size=1), BasicConv2d(192, 320, kernel_size=3, stride=2)
        )
...
class InceptionE(nn.Module):
    def __init__(self, input_channels):
        ...
        self.branch_pool = nn.Sequential(
            nn.AvgPool2d(kernel_size=3, stride=1, padding=1), BasicConv2d(input_channels, 192, kernel_size=1)
        )
