...
class Inception_Stem(nn.Module):
    ...
    def __init__(self, input_channels):
        ...
        self.branch7x7b = nn.Sequential(
            BasicConv2d(160, 64, kernel_size=1), BasicConv2d(64, 96, kernel_size=3, padding=1)
        )
...
class InceptionB(nn.Module):
    ...
    def __init__(self, input_channels):
        ...
        self.branchpool = nn.Sequential(
            nn.AvgPool2d(3, stride=1, padding=1), BasicConv2d(input_channels, 128, kernel_size=1)
        )
